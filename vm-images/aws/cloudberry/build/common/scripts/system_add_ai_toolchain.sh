...
echo "=== [1/9] claude (Anthropic Claude Code, native installer) ==="
run_as_user bash -c 'curl -fsSL https://claude.ai/install.sh | bash'

echo "=== [2/9] pi (PI coding agent, npm) ==="
